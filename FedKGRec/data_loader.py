...
def load_data(args):
    n_user, n_item, train_data, eval_data, test_data, user_history_dict = load_rating(
        args
    )
    ...
    def __init__(self, data):
        self.cfg = {
            "movieKnowledgeGraphDataset": {
                "item2id_path": "./data/movieKnowledgeGraphDataset/item_index2entity_id.txt",
                "kg_path": "./data/movieKnowledgeGraphDataset/kg.txt",
                "rating_path": "./data/movieKnowledgeGraphDataset/ratings.dat",
                "rating_sep": "::",
                "threshold": 1.0,
            },
            "recipeKnowledgeGraphDataset": {
                "item2id_path": "./data/recipeKnowledgeGraphDataset/item_index2entity_id.txt",
                "kg_path": "./data/recipeKnowledgeGraphDataset/kg.txt",
                "rating_path": "./data/recipeKnowledgeGraphDataset/ratings.dat",
                "rating_sep": "::",
                "threshold": 3.0,
            },
        }
